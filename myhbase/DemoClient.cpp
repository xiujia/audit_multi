...
main(int argc, char** argv) 
{
  ...
  try {
   ...
   std::string tt("cache_monitor_data");
    //
	...
	/*  	
        ...
        */
		...
		std::vector<TRowResult> rowResult;
  	    ...
  	    mutations.back().column = "colfam1:";
 	     mutations.back().value = "";
	  	
 	     client.mutateRow(tt, row, mutations, dummyAttributes);
 	     client.getRow(rowResult, tt, row, dummyAttributes);
 		     printRow(rowResult);
      }
