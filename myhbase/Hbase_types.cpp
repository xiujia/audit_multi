...
IOError::IOError(const IOError& other44) : TException() {
  message = other44.message;
  __isset = other44.__isset;
}
IOError& IOError::operator=(const IOError& other45) {
...
IllegalArgument::IllegalArgument(const IllegalArgument& other46) : TException() {
  message = other46.message;
  __isset = other46.__isset;
}
IllegalArgument& IllegalArgument::operator=(const IllegalArgument& other47) {
...
AlreadyExists::AlreadyExists(const AlreadyExists& other48) : TException() {
  message = other48.message;
  __isset = other48.__isset;
}
AlreadyExists& AlreadyExists::operator=(const AlreadyExists& other49) {
